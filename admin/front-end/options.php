<div class="wrap" id="of_container">
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="info_bar">
			...
			<button id="of_generate_less" type="button" class="button-primary"><?php _e( 'Generate Less to CSS', 'zorka' ); ?></button>


			<button id="of_save" type="button" class="button-primary"><?php _e('Save All Changes','zorka');?></button>
		...
		<div class="save_bar"> 
			...
			<button id ="of_save" type="button" class="button-primary"><?php  _e('Save All Changes','zorka');?></button>
			<button id ="of_reset" type="button" class="button submit-button reset-button" ><?php _e('Options Reset','zorka');?></button>

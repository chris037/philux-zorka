...
class Zorka_Product_Category_Widget extends  G5Plus_Widget {
    public function __construct() {
        ...
        if(class_exists( 'WooCommerce' )){
            ...
            $this->widget_description = __( "Product Category", 'zorka' );
            $this->widget_id          = 'widget-product-categories';
            $this->widget_name        = __( 'Zorka: Product Category', 'zorka' );
            $this->settings           = array(
                'title'  => array(
                    'type'  => 'text',
                    'std'   => __( '', 'zorka' ),
                    'label' => __( 'Title', 'zorka' )
                ),
                'category' => array(
                    'type' => 'select',
                    'std' =>'',
                    'label' => __('Category','zorka'),
                    'options' => $categories
                ),
                'col_width' => array(
                    'type' => 'select',
                    'std' =>'',
                    'label' => __('Width','zorka'),
                    'options' => array(
                        '12' => __('Full width','zorka'),
                        '3' => '1/4',
                        '4' => '1/3',
                        '6' => '1/2',
                        '8' => '2/3'

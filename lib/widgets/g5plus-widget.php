				...
				case "icon":
					...
					<div style="margin: 13px 0">
						...
						<div>
							...
							<input style="float: right"  title="<?php echo __('Click to browse icon','zorka') ?>" class="browse-icon button-secondary" type="button" value="<?php echo __('Browse...','zorka') ?>" />
				...
				case "image":
					...
					<div style="margin: 13px 0">
						...
						<div class="widget-image-field">
							...
							<button style="float: right" title="<?php echo __('Click to browse image','zorka') ?>" class="browse-images button-secondary" type="button"><?php echo __('Browse...','zorka') ?></button>
						</div>

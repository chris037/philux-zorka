...
function zorka_script() {
    ...
    $translation_array = array(
        'product_compare' => __('Compare','zorka'),
        'product_wishList' => __('WishList','zorka'),
        'product_add_to_cart' => __('Add to cart','zorka'),
        'product_view_cart' => __('View cart','zorka')
    );
    wp_localize_script( 'zorka_app', 'zorka_constant', $translation_array );

    wp_localize_script('zorka_app' , 'zorka_ajax_url' , get_site_url() . '/wp-admin/admin-ajax.php' );
...
if (is_admin()) {
    ...
    function g5plus_popup_icon_script() {
        ...
        wp_localize_script('g5plus_popup_icon_js' , 'zorka_ajax_url' , get_site_url() . '/wp-admin/admin-ajax.php' );

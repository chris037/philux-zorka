...
function zorka_classes_search()
{
    ...
    if ($keyword) {
        ...
        if ($search && $search->post_count > 0) {
            ...
            $html = '<div class="no-post">' . __("No classes found",'zorka') . '</div>';
...
function zorka_popup_icon()
{
    ...
    ob_start();
    ?>
    <div id="zorka-popup-icon-wrapper">
...
function zorka_panel_selector_callback() {
    ...
    <div id="panel-style-selector">
        <div class="panel-wrapper">
            ...
            <div class="panel-selector-header"><?php _e('Style Selector','zorka');?></div>
            <div class="panel-selector-body clearfix">
                <section class="panel-selector-section clearfix">
                    <h3 class="panel-selector-title"><?php _e('Primary Color','zorka'); ?></h3>
                ...
                <section class="panel-selector-section clearfix">
                    <h3 class="panel-selector-title"><?php _e('Layout','zorka'); ?></h3>
                    <div class="panel-selector-row clearfix">
                        <a data-type="layout" data-value="wide" href="#" class="panel-selector-btn"><?php _e('Wide','zorka'); ?></a>
                        <a data-type="layout" data-value="boxed" href="#" class="panel-selector-btn"><?php _e('Boxed','zorka'); ?></a>
                    </div>
                </section>

                <section class="panel-selector-section clearfix">
                    <h3 class="panel-selector-title"><?php _e('Background','zorka'); ?></h3>
                    <div class="panel-selector-row clearfix">
                ...
                <section class="panel-selector-section clearfix">
                    <div class="panel-selector-row clearfix">
                        <a id="panel-selector-reset" href="#" class="panel-selector-btn"><?php _e('Reset','zorka'); ?></a>
                    </div>
                </section>
            </div>
        </div>

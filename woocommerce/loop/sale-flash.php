    ...
    <div class="product-item-feature">
        <?php if ($product->is_on_sale()) : ?>
            <?php if ($product_sale_flash_mode == 'percent') : ?>
                ...
                <?php endif; ?>
            <?php else: ?>
                <?php echo apply_filters( 'woocommerce_sale_flash', '<div class="on-sale"><span>' . __( 'Sale!', 'woocommerce' ) . '</span></div>', $post, $product ); ?>
            <?php endif; ?>
        <?php endif; ?>
        <?php if ($product_new == 'yes') : ?>
            <div class="on-new"><span><?php _e("New","zorka"); ?></span></div>
        <?php endif; ?>
    </div>
<?php endif; ?>
...
<div class="product-deal-countdown" data-date-end="<?php echo esc_attr($sales_price_date_to); ?>">
    <div class="product-deal-countdown-inner">
        <div class="countdown-section">
            ...
            <span class="countdown-period"><?php _e('Days','zorka'); ?></span>
        </div>
        <div class="countdown-section">
            <span class="countdown-amount countdown-hours"></span>
            <span class="countdown-period"><?php _e('Hours','zorka'); ?></span>
        </div>
        <div class="countdown-section">
            <span class="countdown-amount countdown-minutes"></span>
            <span class="countdown-period"><?php _e('Minutes','zorka'); ?></span>
        </div>
        <div class="countdown-section">
            <span class="countdown-amount countdown-seconds"></span>
            <span class="countdown-period"><?php _e('Seconds','zorka'); ?></span>
        </div>
    </div>
</div>
<?php endif; ?>

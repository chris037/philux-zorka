    ...
    <div class="entry-wrapper clearfix">
        ...
        <?php if (!is_single()) : ?>
            ...
            <div class="entry-read-more">
                <a class="zorka-button button-md style1" href="<?php the_permalink(); ?>" rel="bookmark" title="<?php _e("Read more","zorka"); ?>"><?php _e("Read more","zorka"); ?></a>
            </div>
        <?php else : ?>
            ...
            <?php wp_link_pages( array(
                'before'      => '<div class="zorka-page-links"><span class="zorka-page-links-title">' . __( 'Pages:', 'zorka' ) . '</span>',
                'after'       => '</div>',
